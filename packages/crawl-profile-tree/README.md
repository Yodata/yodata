...
@yodata/crawl-profile-tree/1.0.0-alpha.0 darwin-x64 node-v16.15.1
...
_See code: [src/commands/crawl-profile-tree.js](https://github.com/Yodata/yodata/blob/v1.0.0-alpha.0/src/commands/crawl-profile-tree.js)_
<!-- commandsstop -->
