...
@yodata/plugin-create-api-key/1.0.3 darwin-x64 node-v16.15.1
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v1.0.3/src/commands/create-api-key.js)_
<!-- commandsstop -->
