...
@yodata/plugin-create-api-key/0.2.9-alpha.0 darwin-x64 node-v12.15.0
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.2.9-alpha.0/src/commands/create-api-key.js)_
<!-- commandsstop -->
