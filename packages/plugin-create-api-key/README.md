...
@yodata/plugin-create-api-key/0.2.13 darwin-x64 node-v12.16.0
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.2.13/src/commands/create-api-key.js)_
<!-- commandsstop -->
