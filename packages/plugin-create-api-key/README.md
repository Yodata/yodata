...
@yodata/plugin-create-api-key/0.2.2 darwin-x64 node-v10.15.0
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.2.2/src/commands/create-api-key.js)_
<!-- commandsstop -->
