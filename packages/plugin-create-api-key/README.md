...
@yodata/plugin-create-api-key/0.3.2 darwin-x64 node-v10.19.0
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.3.2/src/commands/create-api-key.js)_
<!-- commandsstop -->
