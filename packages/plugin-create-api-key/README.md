...
@yodata/plugin-create-api-key/0.3.0 darwin-x64 node-v12.16.1
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.3.0/src/commands/create-api-key.js)_
<!-- commandsstop -->
