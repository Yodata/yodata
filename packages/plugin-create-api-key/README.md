...
@yodata/plugin-create-api-key/0.5.9 darwin-x64 node-v10.23.0
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/create-api-key.js)_
<!-- commandsstop -->
