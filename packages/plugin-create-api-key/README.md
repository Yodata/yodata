...
@yodata/plugin-create-api-key/0.5.14 darwin-x64 node-v14.17.6
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.5.14/src/commands/create-api-key.js)_
<!-- commandsstop -->
