...
@yodata/plugin-create-api-key/0.5.1 darwin-x64 node-v12.19.0
...
_See code: [src/commands/create-api-key.js](https://github.com/Yodata/yodata/blob/v0.5.1/src/commands/create-api-key.js)_
<!-- commandsstop -->
