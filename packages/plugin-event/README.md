...
@yodata/plugin-event/0.5.9 darwin-x64 node-v10.23.0
...
OPTIONS
  ...
  -p, --profile=profile         [default: bhhs-next-profile-events-handler] command context
```

_See code: [src/commands/event/set-topic.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/event/set-topic.js)_
...
_See code: [src/commands/pub/index.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/pub/index.js)_
...
_See code: [src/commands/sub/index.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/sub/index.js)_
...
_See code: [src/commands/sub/add.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/sub/add.js)_
...
_See code: [src/commands/sub/remove.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/sub/remove.js)_
...
_See code: [src/commands/sub/stop.js](https://github.com/Yodata/yodata/blob/v0.5.9/src/commands/sub/stop.js)_
<!-- commandsstop -->
