...
@yodata/plugin-event/0.2.6 darwin-x64 node-v10.15.0
...
_See code: [src/commands/event/set-topic.js](https://github.com/Yodata/yodata/blob/v0.2.6/src/commands/event/set-topic.js)_
...
_See code: [src/commands/pub/index.js](https://github.com/Yodata/yodata/blob/v0.2.6/src/commands/pub/index.js)_
...
_See code: [src/commands/sub/index.js](https://github.com/Yodata/yodata/blob/v0.2.6/src/commands/sub/index.js)_
...
_See code: [src/commands/sub/add.js](https://github.com/Yodata/yodata/blob/v0.2.6/src/commands/sub/add.js)_
...
_See code: [src/commands/sub/remove.js](https://github.com/Yodata/yodata/blob/v0.2.6/src/commands/sub/remove.js)_
<!-- commandsstop -->
